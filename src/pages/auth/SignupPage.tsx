...
export function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-ink-900 px-4 py-12">
      ...
      <div className="w-full max-w-md rounded-2xl border border-ink-700 bg-ink-800 p-8 shadow-xl">
        <h1 className="text-2xl font-semibold text-stone-50">Create your account</h1>
